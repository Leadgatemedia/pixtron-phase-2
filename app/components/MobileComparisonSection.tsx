  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <GlassCard style={{ height: 152, display: "flex", flexDirection: "column", justifyContent: "center", gap: 20, padding: 25 }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", gap: 8 }}>
            ...
            <span style={{ color: "#0F9D58", fontSize: 18, lineHeight: "20px" }}>↑ vs 0.1% CTR</span>
          </div>
          <span style={{ color: "rgba(255,255,255,0.5)", fontSize: 16, lineHeight: "16px" }}>Compared to digital display ads</span>
        </GlassCard>
        ...
        <GlassCard style={{ height: 152, display: "flex", flexDirection: "column", justifyContent: "center", gap: 20, padding: 25 }}>
          ...
          <span style={{ color: "rgba(255,255,255,0.5)", fontSize: 16, lineHeight: "16px" }}>Brand recall after 24 hours</span>
        </GlassCard>

        <GlassCard style={{ padding: 25 }}>
          <h3 style={{ margin: 0, color: "#fff", fontSize: 18, fontWeight: 600, lineHeight: "28px" }}>Cost Per Meaningful Interaction</h3>
